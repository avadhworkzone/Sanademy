...
class AppImageAssets {
  ...
  static const String selectedProgressIcon =
      '${AppConstants.baseIconAssetsPath}selectedProgressIcon.svg';

  /// question screen
  static const String clockIcon =
      '${AppConstants.baseIconAssetsPath}clockIcon.svg';
  ...
  static String locationIcn =
      "${AppConstants.baseImageAssetsPath}locationIcn.png";
  static String phoneNumberImg =
      "${AppConstants.baseImageAssetsPath}phoneNumberImg.png";
  static String emailAddressImg =
      "${AppConstants.baseImageAssetsPath}emailAddressImg.png";
