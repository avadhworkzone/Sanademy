...
class SignUpNewScreen extends StatefulWidget {
  const SignUpNewScreen({super.key});

  @override
  State<SignUpNewScreen> createState() => _SignUpNewScreenState();
}

class _SignUpNewScreenState extends State<SignUpNewScreen> {
