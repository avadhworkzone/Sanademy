              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 5.h),
                    _buildCourseDetailRow(AppImageAssets.videoPlay, "8.5 hours on-demand video"),
                    SizedBox(height: 9.h),
                    _buildCourseDetailRow(AppImageAssets.list, "2 articles"),
                    SizedBox(height: 9.h),
                    _buildCourseDetailRow(AppImageAssets.downloadCircle, "1 downloadable resource"),
                    SizedBox(height: 9.h),
                    _buildCourseDetailRow(AppImageAssets.certificate, "Certificate of completion"),
                    SizedBox(height: 9.h),
                    _buildCourseDetailRow(AppImageAssets.tv, "Access on mobile and TV"),
                  ],
                ),
              ),
            ),
                    ...
                    Padding(
                      ...
                      child: _buildExpandableSection(
                        ...
                        content: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            _buildBulletPoint("How to recognize the role of ChatGPT in ..."),
                            _buildBulletPoint("How to optimize daily marketing routine"),
                            _buildBulletPoint("How to optimize daily marketing routine"),
                          ],
                        ),
                      ),
                      ...
                      child: _buildExpandableSection(
                        ...
                        content: Column(
                          ...
                          children: [
                            ...
                            _buildBulletPoint("Learn to use AI tools effectively"),
                            _buildBulletPoint("Build your own AI-powered applications"),
                          ],
                        ),
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: _buildExpandableSection(
                        ...
                        content: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            _buildBulletPoint("Beginners who want to learn AI"),
                            _buildBulletPoint("Professionals looking to upskill"),
                            _buildBulletPoint("Anyone curious about AI applications"),
                          ],
                        ),
                      ),
                    ),
                            ...
                            child: Theme(
                              ...
                              child: ExpansionTile(
                                ...
                                children: [
                                  const Divider(color: AppColors.greyE0),
                                  ListView.separated(
                                    separatorBuilder: (context, index) => const Divider(color: AppColors.greyE0),
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      switch (index) {
                                        ...
                                        case 1:
                                          ...
                                          break;
                                        case 2:
                                          icon = AppImageAssets.yellowPlay; // Yellow circle (play icon)
                                          break;
                                        case 3:
                                          icon = AppImageAssets.lock; // Lock icon
                                          break;
                                        default:
                                          icon = AppImageAssets.lock; // Default fallback
                                      }
                                      return Padding(
  ...
  return Row(
    children: [
      ...
      Expanded(
        child: CustomNewText(
          text,
          fontSize: 14.sp, color: AppColors.grey73,fontWeight: FontWeight.w400,
        ),
      ),
    ],
  );
...
Widget _buildBulletPoint(String text) {
  return Padding(
    ...
    child: Row(
      ...
      children: [
        CircleAvatar(backgroundColor: AppColors.teal,radius: 3.sp,),
        SizedBox(width: 9.w),
        Expanded(
          child: CustomNewText(
            text,
           fontSize: 14.sp, color: AppColors.grey73,
          ),
        ),
      ],
    ),
      ...
      children: [
        ...
        Row(
          children: [
            ...
            const CircleAvatar(
              radius: 12.0,
              backgroundImage: AssetImage(AppImageAssets.teacherImage,), // Replace with your image path
            ),
            SizeConfig.sW3,
            CustomNewText(
              "Devid Jonson",
